...
import { 
  User, BookOpen, HeartPulse, MessageSquare, Award, StickyNote, 
  MapPin, Phone, Mail, GraduationCap, X, Search, Filter, ChevronRight, Maximize, Minimize
} from 'lucide-react';

// --- Mock Data ---
const MOCK_STUDENTS = [
  { id: '24120101', name: 'Trần Quang Tuấn', class: '24CTT4', status: 'Nguy cơ', gpa: 1.8, stress: 'Cao', avatar: 'bg-purple-500' },
  { id: '24120102', name: 'Nguyễn Thị Bé', class: '24CTT4', status: 'An toàn', gpa: 3.2, stress: 'Thấp', avatar: 'bg-blue-500' },
  { id: '24120103', name: 'Lê Văn Cường', class: '24CTT4', status: 'Cảnh báo', gpa: 2.5, stress: 'Vừa', avatar: 'bg-emerald-500' },
  { id: '24120104', name: 'Phạm Minh Đức', class: '24CTT4', status: 'An toàn', gpa: 3.8, stress: 'Thấp', avatar: 'bg-amber-500' },
  { id: '24120105', name: 'Hoàng Thị Yến', class: '24CTT4', status: 'Cảnh báo', gpa: 2.0, stress: 'Cao', avatar: 'bg-rose-500' },
  { id: '24120106', name: 'Bùi Tuấn Anh', class: '24CTT4', status: 'An toàn', gpa: 3.5, stress: 'Thấp', avatar: 'bg-cyan-500' },
];
...
const radarData = [
  ...
  { subject: 'Tâm lý (Ổn định)', value: 50 },
        ...
        {MOCK_STUDENTS.map((student, idx) => (
          ...
          >
            <div className="flex items-start gap-4">
              <div className={`w-12 h-12 rounded-xl ${student.avatar} flex items-center justify-center text-white font-bold text-lg shadow-lg shrink-0`}>
            ...
            >
              ...
              <div className="flex-1 overflow-y-auto custom-scrollbar p-6">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 auto-rows-[160px]">
                  ...
                  >
                    <div className={`absolute top-0 right-0 w-64 h-64 ${selectedStudent.avatar}/10 rounded-full blur-3xl transition-all duration-700`} />
                    
                    <div className="flex gap-6 relative z-10 h-full">
                      <div className="shrink-0 flex flex-col items-center gap-3">
                        <div className={`w-24 h-24 rounded-2xl ${selectedStudent.avatar} p-1 shadow-glow-purple`}>
                      ...
                      <div className="flex-1 flex flex-col justify-center">
                        ...
                        <p className="text-purple-400 font-medium text-sm mb-4">MSSV: {selectedStudent.id} · Lớp {selectedStudent.class}</p>
                  ...
                  {/* Ô 4: LỊCH SỬ CHAT AI (Chuyển sang trái và to hơn) */}
                  <motion.div 
                  ...
                  {/* Ô 5: RADAR CHART (Chuyển sang phải và nhỏ lại) */}
                  <motion.div 
